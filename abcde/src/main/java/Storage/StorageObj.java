...
public class StorageObj {
	...
	public void setSplitQuestion(String line) {
		line.replace(" ", "");
		String[] str_array = line.split(",");
		for (String string : str_array) {
			addSplitQuestion(string);
		}

	}

	public void setQuestionNormalized(String line) {
		line.replace(" ", "");
		String[] str_array = line.split(",");
		for (String string : str_array) {
			addQuestionNormalized(string);
		}

	}

	public void setSplitQuestionKind(String line) {
		line.replace(" ", "");
		String[] str_array = line.split(",");
		for (String string : str_array) {
			addSplitQuestionKind(string);
		}
